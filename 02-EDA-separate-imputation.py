...
# Step 2 split train data into train and validation set
...
# Initialize Iterative Imputer with BayesianRidge as the estimator
iterative_imputer = IterativeImputer(estimator=BayesianRidge(), random_state=42)

# Perform imputation on "LotFrontage" using the specified columns as predictors
X_train_imputed = X_train.copy()  # Make a copy of X_train
...
# Apply the same imputer to impute missing values in the validation set
X_val_imputed = X_val.copy()  # Make a copy of the validation set
