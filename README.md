...
```
cd existing_repo
git remote add origin https://gitlab.com/personal-project6453841/house-price-prediction.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/personal-project6453841/house-price-prediction/-/settings/integrations)
