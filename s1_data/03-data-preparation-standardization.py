...
X_train = pd.read_csv("data/X_train_knn.csv")
X_val = pd.read_csv("data/X_val_knn.csv")
test_final = pd.read_csv("data/test_final_knn.csv")
y_train = pd.read_csv("data/y_train_knn.csv")
y_val = pd.read_csv("data/y_val_knn.csv")
...
X_train.to_csv("data/model_data/X_train_knn.csv", index=False)
X_val.to_csv("data/model_data/X_val_knn.csv", index=False)
test_final.to_csv("data/model_data/test_final_knn.csv", index=False)
y_train.to_csv("data/model_data/y_train_knn.csv", index=False)
y_val.to_csv("data/model_data/y_val_knn.csv", index=False)
