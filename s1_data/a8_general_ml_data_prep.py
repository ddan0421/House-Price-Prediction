...
"""
General ML Model Data Preparation Workflow:
...
X_train_encoded = pd.get_dummies(X_train_engineered, columns=nominal_cat, drop_first=False, dtype="int8")
X_val_encoded = pd.get_dummies(X_val_engineered, columns=nominal_cat, drop_first=False, dtype="int8")
test_encoded = pd.get_dummies(test_engineered, columns=nominal_cat, drop_first=False, dtype="int8")
...
tables = {
    "X_train_ml": X_train_transformed,
    "X_val_ml": X_val_transformed,
    "test_ml": test_transformed,
}
